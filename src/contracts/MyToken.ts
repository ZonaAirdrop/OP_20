...
export class MyToken extends DeployableOP_20 {
    ...
    public override onDeployment(_calldata: Calldata): void {
        const maxSupply: u256 = u256.fromString('1000000000000000000000000000'); // Your max supply. (1000000000000000000000)
        const decimals: u8 = 18; // 18.
        const name: string = 'Test'; // zonaairdrop.
        const symbol: string = 'TEST'; // zonaa.
